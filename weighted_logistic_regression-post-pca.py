...
print('Train Weighted Accuracy (5 min): ',model_5.score(normalize(X_train,means,stds,v,l),np.floor((np.sign(Y_train[:,0]) + 1)/2),sample_weight = np.abs(Y_train[:,0])))
...
print('Dev Weighted Accuracy (5 min): ',model_5.score(normalize(X_dev,means,stds,v,l),np.floor((np.sign(Y_dev[:,0]) + 1)/2),sample_weight = np.abs(Y_dev[:,0])))
...
print('Test Weighted Accuracy (5 min): ',model_5.score(normalize(X_test,means,stds,v,l),np.floor((np.sign(Y_test[:,0]) + 1)/2),sample_weight = np.abs(Y_test[:,0])))
...
print('Train Weighted Accuracy (10 min): ',model_10.score(normalize(X_train,means,stds,v,l),np.floor((np.sign(Y_train[:,1]) + 1)/2),sample_weight = np.abs(Y_train[:,1])))
...
print('Dev Weighted Accuracy (10 min): ',model_10.score(normalize(X_dev,means,stds,v,l),np.floor((np.sign(Y_dev[:,1]) + 1)/2),sample_weight = np.abs(Y_dev[:,1])))
...
print('Test Weighted Accuracy (10 min): ',model_10.score(normalize(X_test,means,stds,v,l),np.floor((np.sign(Y_test[:,1]) + 1)/2),sample_weight = np.abs(Y_test[:,1])))
...
print('Train Weighted Accuracy (20 min): ',model_20.score(normalize(X_train,means,stds,v,l),np.floor((np.sign(Y_train[:,2]) + 1)/2),sample_weight = np.abs(Y_train[:,2])))
...
print('Dev Weighted Accuracy (20 min): ',model_20.score(normalize(X_dev,means,stds,v,l),np.floor((np.sign(Y_dev[:,2]) + 1)/2),sample_weight = np.abs(Y_dev[:,2])))
...
print('Test Weighted Accuracy (20 min): ',model_20.score(normalize(X_test,means,stds,v,l),np.floor((np.sign(Y_test[:,2]) + 1)/2),sample_weight = np.abs(Y_test[:,2])))
...
model_means_3 = means
model_stds_3 = stds
pickle.dump(model_means_3,open("model_possibility_pca_3_means.p","wb"))
pickle.dump(model_stds_3,open("model_possibility_pca_3_stds.p","wb"))
model_possibility_3 = model_5
pickle.dump( model_possibility_3, open( "model_possibility_pca_5min_3.p", "wb" ) )
model_possibility_3 = model_10
pickle.dump( model_possibility_3, open( "model_possibility_pca_10min_3.p", "wb" ) )
model_possibility_3 = model_20
pickle.dump( model_possibility_3, open( "model_possibility_pca_20min_3.p", "wb" ) )
